...
<%@page import="com.cts.cbc.vo.TransactiondetailsForFundVo"%>
...
%> 
	...
	<%
		...
		TransactiondetailsForFundVo user;
		String userId = vo.getUserId();
		String roleType = vo.getRoleType();

		DisplayUserDAO d = new DisplayUserDAO();
		List<TransactiondetailsForFundVo> l = new ArrayList<TransactiondetailsForFundVo>();
		l = d.getTransactionsdetailForFundUser(vo);
		Iterator<TransactiondetailsForFundVo> i = l.iterator();
...
<thead>
		...
		<%
			while (i.hasNext()) 
			{
					user = (TransactiondetailsForFundVo) i.next();
		%>
<tbody>
		<tr>
