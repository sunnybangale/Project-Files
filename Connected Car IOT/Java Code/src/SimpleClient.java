...
private static String ThingName1 = "Audi";
private static String ThingName2 = "Mercedes";
	...
	try {
		...
		SimpleClient client = new SimpleClient(config);
			...
			{	
				...
				result2 = client.readProperty(ThingworxEntityTypes.Things, ThingName2, "AlertStatus", 10000);
				
				result3 = client.readProperty(ThingworxEntityTypes.Things, ThingName1, "ManualAlert", 10000);
				result4 = client.readProperty(ThingworxEntityTypes.Things, ThingName2, "ManualAlert", 10000);
				...
				String AlertStatus2= result2.getFirstRow().getStringValue("AlertStatus");
				
				String ManualAlert1= result3.getFirstRow().getStringValue("ManualAlert");
				String ManualAlert2= result4.getFirstRow().getStringValue("ManualAlert");
				
				
				
				System.out.println("Alert 1 "+AlertStatus1+ " Alert 2 "+ AlertStatus2 );
				if(AlertStatus1=="true" || AlertStatus2=="true" || ManualAlert1=="true" || ManualAlert2=="true" )
					pin.high();
				else
					pin.low();
				//JOptionPane.showMessageDialog(null, "Alert 1 "+AlertStatus1+ " Alert 2 "+ AlertStatus2 );
				
				System.out.println(" Manual Alert 1 "+ ManualAlert1 + " Manual Alert 2 "+ ManualAlert2);
				...
				*/
			    ...
			    double newHumidity=temp[0];
					...
					LocationPrimitive location2 = new LocationPrimitive(Double.valueOf(newLatitude),Double.valueOf(newLongitude), Double.valueOf(0.0));
					// This will set the CurrentLocation property of the Thing to the GPS 
					// coordinates of Boston, MA.
					client.writeProperty(ThingworxEntityTypes.Things, ThingName2, "Location", location2, 5000);
					
					
					
					NumberPrimitive temperature1 = new NumberPrimitive(newTemperature);
					if(temp[1]!=-1)
					client.writeProperty(ThingworxEntityTypes.Things, ThingName1, "Temperature", temperature1, 5000);
					
					NumberPrimitive temperature2 = new NumberPrimitive(newTemperature);
					if(temp[1]!=-1)
					client.writeProperty(ThingworxEntityTypes.Things, ThingName2, "Temperature", temperature2, 5000);

					
					NumberPrimitive humidity1 = new NumberPrimitive(newHumidity);
					if(temp[0]!=-1)
					client.writeProperty(ThingworxEntityTypes.Things, ThingName1, "Humidity", humidity1, 5000);
					
					NumberPrimitive humidity2 = new NumberPrimitive(newHumidity);
					if(temp[0]!=-1)
					client.writeProperty(ThingworxEntityTypes.Things, ThingName2, "Humidity", humidity2, 5000);

					
					NumberPrimitive speed1 = new NumberPrimitive(newSpeed);
					client.writeProperty(ThingworxEntityTypes.Things, ThingName1, "Speed", speed1, 5000);
				
					NumberPrimitive speed2 = new NumberPrimitive(newSpeed);
					client.writeProperty(ThingworxEntityTypes.Things, ThingName2, "Speed", speed2, 5000);
