...
public class question2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(690, 585));
        ...
        jLabel2.setText("Do you have any FEELINGS OF GUILT ? ");
        ...
        a0.setBounds(27, 164, 100, 23);

        buttonGroup1.add(a1);
        a1.setText("Self reproach, feels he has let people down   ");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(27, 205, 340, 23);

        buttonGroup1.add(a2);
        a2.setText("Ideas of guilt or rumination over past errors or sinful deeds ");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(27, 246, 380, 23);

        buttonGroup1.add(a3);
        a3.setText("Present illness is a punishment. Delusions of guilt   ");
        a3.setOpaque(false);
        getContentPane().add(a3);
        a3.setBounds(27, 287, 360, 23);
        ...
        buttonGroup1.add(a4);
        a4.setText("Hears accusatory or denunciatory voices and/or experiences threatening visual hallucinations   ");
        a4.setOpaque(false);
        getContentPane().add(a4);
        a4.setBounds(27, 328, 550, 23);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gesture/ques bk.jpg"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(0, 0, 750, 547);
