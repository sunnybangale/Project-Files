...
int id;
 //   private Object Calender;
    ...
    private void initComponents() {
        ...
        jLabel6.setBounds(40, 520, 120, 40);
        ...
        name_tf.setBounds(220, 20, 280, 20);
        ...
        address_tf.setBounds(220, 120, 280, 20);
        ...
        dt_CBX.setBounds(220, 170, 70, 20);
        ...
        prof_CBX.setBounds(217, 530, 280, 20);
        ...
        user_tf.setBounds(220, 300, 280, 20);

        jLabel9.setText("PASSWORD");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(40, 340, 150, 27);
        getContentPane().add(input_pwd);
        input_pwd.setBounds(220, 340, 280, 20);

        jLabel10.setText("CONFIRM PASSWORD");
        getContentPane().add(jLabel10);
        jLabel10.setBounds(40, 380, 150, 20);
        ...
        confirm_pwd.setBounds(220, 380, 280, 20);

        jLabel11.setText("EMAIL ID");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(40, 420, 100, 20);

        jLabel12.setText("CONTACT NUMBER");
        getContentPane().add(jLabel12);
        jLabel12.setBounds(40, 254, 120, 30);
        ...
        phone_no_tf.setBounds(217, 260, 280, 20);
        ...
        email_tf.setBounds(217, 420, 280, 20);
        ...
        jPanel1.setBounds(220, 50, 267, 53);

        jLabel16.setText("+91");
        getContentPane().add(jLabel16);
        jLabel16.setBounds(170, 260, 30, 14);

        namecons.setForeground(new java.awt.Color(255, 51, 51));
        getContentPane().add(namecons);
        namecons.setBounds(510, 20, 141, 20);
        ...
        sessions_tf.setBounds(300, 480, 140, 20);
...
lbl1.setText("<html>"+"NAME: " +name+"<br>"+"GENDER: " +gender+"<br>"+"ADDRESS: "+address+"<br>"+"DOB: "+yr+"-"+mth+"-"+dt+"<br>"+"PHONE NUMBER: "+phone+"<br>"+"USERID: "+userID+"<br>"+"PASSWORD: "+pwd+"<br>"+"EMAILID: "+email+"<br>"+"NUMBER OF SESSIONS ATENDED: " +sessions+"<br>"+"PROFESSION: " + profession + "</html>");
