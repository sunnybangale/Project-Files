...
public class question1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Are you in a DEPRESSED MOOD (Sadness, hopeless, helpless, worthless) ? ");
        ...
        a0.setBounds(30, 160, 150, 23);

        buttonGroup1.add(a1);
        a1.setText("These feeling states indicated only on questioning");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(27, 205, 350, 23);

        buttonGroup1.add(a2);
        a2.setText("These feeling states spontaneously reported verbally ");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(27, 246, 350, 23);

        buttonGroup1.add(a3);
        a3.setText("<html>Communicates feeling states non-verbally—i.e., through facial expression, posture, voice,<br> and tendency to weep</html> ");
        a3.setOpaque(false);
        ...
        jButton1.setBounds(40, 410, 190, 60);

        buttonGroup1.add(a4);
        a4.setText("<html>Patient reports VIRTUALLY ONLY these feeling states in his spontaneous <br>verbal and non-verbal communication </htmll>");
        a4.setOpaque(false);
        getContentPane().add(a4);
        a4.setBounds(30, 340, 647, 40);
