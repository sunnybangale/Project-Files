...
public class question15 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Did you have any LOSS OF WEIGHT (when rating by history) ?            ");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(27, 106, 481, 56);

        buttonGroup1.add(a0);
        a0.setText("No weight loss");
        a0.setOpaque(false);
        getContentPane().add(a0);
        a0.setBounds(27, 164, 190, 23);

        buttonGroup1.add(a1);
        a1.setText("Probably weight loss associated with present illness              ");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(27, 205, 370, 23);

        buttonGroup1.add(a2);
        a2.setText("Definite (according to patient) weight loss   ");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(27, 246, 310, 23);

        buttonGroup1.add(a3);
        a3.setText("Not assessed ");
        a3.setOpaque(false);
        getContentPane().add(a3);
        a3.setBounds(27, 287, 230, 23);
...
catch(Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(question15.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
