 ...
 * @author Owner
 */
public class question19 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Any PARANOID SYMPTOMS observed? ");
        ...
        a0.setBounds(30, 180, 90, 23);

        buttonGroup1.add(a1);
        a1.setText("Suspicious");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(30, 220, 100, 23);

        buttonGroup1.add(a2);
        a2.setText("Ideas of reference");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(30, 260, 180, 23);
        ...
        buttonGroup1.add(a3);
        a3.setText("Delusions of reference and persecution ");
        a3.setOpaque(false);
        getContentPane().add(a3);
        a3.setBounds(30, 300, 290, 23);
...
catch(Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(question19.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new question19().setVisible(true);
            }
        });
    }
