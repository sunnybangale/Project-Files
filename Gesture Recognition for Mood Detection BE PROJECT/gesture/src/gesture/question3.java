...
public class question3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Do you feel the need to SUICIDE ?");
        ...
        a0.setBounds(27, 164, 150, 23);

        buttonGroup1.add(a1);
        a1.setText("Feels life is not worth living");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(27, 205, 280, 23);

        buttonGroup1.add(a2);
        a2.setText("Wishes he were dead or any thoughts of possible death to  self");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(27, 246, 460, 23);

        buttonGroup1.add(a3);
        a3.setText("Suicidal ideas or gesture");
        a3.setOpaque(false);
        getContentPane().add(a3);
        a3.setBounds(27, 287, 460, 23);
        ...
        buttonGroup1.add(a4);
        a4.setText("Attempts at suicide (any serious attempt rates)   ");
        a4.setOpaque(false);
