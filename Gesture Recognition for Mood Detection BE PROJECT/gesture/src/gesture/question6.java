...
public class question6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Feeling difficulties in WORK AND ACTIVITIES ?");
        ...
        a0.setBounds(27, 164, 130, 23);

        buttonGroup1.add(a1);
        a1.setText("Thoughts and feelings of incapacity, fatigue or weakness related to activities; work or hobbies ");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(27, 205, 540, 23);

        buttonGroup1.add(a2);
        a2.setText("<html>\nLoss of interest in activity; hobbies or work—either directly reported by patient,\n<br>\nor indirect in listlessness, indecision and vacillation (feels he has to push self to work or activities)\n</html>");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(27, 246, 580, 37);

        buttonGroup1.add(a3);
        a3.setText("Decrease in actual time spent in activities or decrease in productivity ");
        a3.setOpaque(false);
        ...
        buttonGroup1.add(a4);
        a4.setText("Stopped working because of present illness   ");
        a4.setOpaque(false);
        getContentPane().add(a4);
        a4.setBounds(27, 342, 350, 23);
