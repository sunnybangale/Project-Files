...
public class question7 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html> Feeling of RETARDATION: PSYCHOMOTOR (Slowness of thought and speech; <br>  impaired ability to concentrate; decreased motor activity) ?  </html>");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(30, 110, 540, 56);

        buttonGroup1.add(a0);
        a0.setText("Normal speech and thought");
        a0.setOpaque(false);
        getContentPane().add(a0);
        a0.setBounds(30, 180, 280, 23);

        buttonGroup1.add(a1);
        a1.setText("Slight retardation at interview ");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(30, 220, 320, 23);

        buttonGroup1.add(a2);
        a2.setText("Obvious retardation at interview");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(30, 260, 310, 23);

        buttonGroup1.add(a3);
        a3.setText("Interview difficult");
        a3.setOpaque(false);
        getContentPane().add(a3);
        a3.setBounds(30, 300, 420, 23);
