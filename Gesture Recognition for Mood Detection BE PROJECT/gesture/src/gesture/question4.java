...
public class question4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INSOMNIA EARLY ?  ");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(27, 106, 481, 56);

        buttonGroup1.add(a0);
        a0.setText("No difficulty falling asleep");
        a0.setOpaque(false);
        getContentPane().add(a0);
        a0.setBounds(30, 190, 210, 23);

        buttonGroup1.add(a1);
        a1.setText("Complains of occasional difficulty falling asleep—i.e., more than 1/2 hour ");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(30, 230, 490, 23);

        buttonGroup1.add(a2);
        a2.setText("Complains of nightly difficulty falling asleep   ");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(30, 270, 410, 23);
