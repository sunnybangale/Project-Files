 ...
 * @author Owner
 */
public class question20 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(695, 585));
        ...
        jLabel2.setText(" Any OBSESSIONAL AND COMPULSIVE SYMPTOMS experienced ?");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(27, 106, 533, 56);

        buttonGroup1.add(a0);
        a0.setText("Absent");
        a0.setOpaque(false);
        getContentPane().add(a0);
        a0.setBounds(30, 180, 120, 23);

        buttonGroup1.add(a1);
        a1.setText(" Mild ");
        a1.setOpaque(false);
        getContentPane().add(a1);
        a1.setBounds(30, 220, 120, 23);

        buttonGroup1.add(a2);
        a2.setText("Severe");
        a2.setOpaque(false);
        getContentPane().add(a2);
        a2.setBounds(30, 260, 120, 23);
...
past_history a = new past_history();
a.setVisible(true);
this.dispose();
...
catch(Exception e)
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(question20.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new question20().setVisible(true);
            }
        });
    }
